...
public class ChequeraConverter {
	...
	public ChequeraModel chequeraToChequeraModel(Chequera ch) {
		...
		chem.setChNumCuenta(ch.getChNumCuenta());
		chem.setChClaveInterbancaria(ch.getChClaveInterbancaria());
	...
	public Chequera chequeraModelToChequera(ChequeraModel chem) {
		...
		ch.setChNumCuenta(chem.getChNumCuenta());
		ch.setChClaveInterbancaria(chem.getChClaveInterbancaria());
